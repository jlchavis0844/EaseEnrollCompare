...
namespace EaseEnrollCompare {
    public partial class Form1 : Form {
        ...
        private void btnOutput_Click(object sender, EventArgs e) {
            ...
            tempStr = (outputInitials + tempStr);
        ...
        public static void RenameHeaders(DataTable dt) {
            ...
            dt.Columns[44].ColumnName = "Compensation";
            dt.Columns[45].ColumnName = "Compensation Type";
            dt.Columns[46].ColumnName = "Pay Cycle";
            dt.Columns[47].ColumnName = "Pay Periods";
            dt.Columns[48].ColumnName = "Payroll Id";
            dt.Columns[49].ColumnName = "Cost Factor";
            dt.Columns[50].ColumnName = "Tobacco User";
            dt.Columns[51].ColumnName = "Disabled";
            dt.Columns[52].ColumnName = "Medicare A Date";
            dt.Columns[53].ColumnName = "Medicare B Date";
            dt.Columns[54].ColumnName = "Medicare C Date";
            dt.Columns[55].ColumnName = "Medicare D Date";
            dt.Columns[56].ColumnName = "Medical PCP Name";
            dt.Columns[57].ColumnName = "Medical PCP ID";
            dt.Columns[58].ColumnName = "Dental PCP Name";
            dt.Columns[59].ColumnName = "Dental PCP ID";
            dt.Columns[60].ColumnName = "IPA Number";
            dt.Columns[61].ColumnName = "OBGYN";
            dt.Columns[62].ColumnName = "Benefit Eligible Date";
            dt.Columns[63].ColumnName = "Unlock Enrollment Date";
            dt.Columns[64].ColumnName = "Original Effective Date Info";
            dt.Columns[65].ColumnName = "Subscriber Key";
            dt.Columns[66].ColumnName = "Plan Type";
            dt.Columns[67].ColumnName = "Plan Effective Start Date";
            dt.Columns[68].ColumnName = "Plan Effective End Date";
            dt.Columns[69].ColumnName = "Plan Admin Name";
            dt.Columns[70].ColumnName = "Plan Display Name";
            dt.Columns[71].ColumnName = "Plan Import ID";
            dt.Columns[72].ColumnName = "Effective Date";
            dt.Columns[73].ColumnName = "Activity Date";
            dt.Columns[74].ColumnName = "Benefit Compensation Amount";
            dt.Columns[75].ColumnName = "Benefit Compensation Type";
            dt.Columns[76].ColumnName = "Coverage Tier";
            dt.Columns[77].ColumnName = "Coverage Details";
            dt.Columns[78].ColumnName = "Election Status";
            dt.Columns[79].ColumnName = "Processed Date";
            dt.Columns[80].ColumnName = "Rider Codes";
            dt.Columns[81].ColumnName = "Action";
            dt.Columns[82].ColumnName = "Waive Reason";
            dt.Columns[83].ColumnName = "Policy Number";
            dt.Columns[84].ColumnName = "Subgroup Number";
            dt.Columns[85].ColumnName = "Age Determination";
            dt.Columns[86].ColumnName = "Carrier";
            dt.Columns[87].ColumnName = "Total Rate";
            dt.Columns[88].ColumnName = "Employee Rate";
            dt.Columns[89].ColumnName = "Spouse Rate";
            dt.Columns[90].ColumnName = "Children Rate";
            dt.Columns[91].ColumnName = "Employee Contribution";
            dt.Columns[92].ColumnName = "Employee Pre-Tax Cost";
            dt.Columns[93].ColumnName = "Employee Post-Tax Cost";
            dt.Columns[94].ColumnName = "Employee Cost Per Deduction Period";
            dt.Columns[95].ColumnName = "Employer Contribution";
            dt.Columns[96].ColumnName = "Employer Cost Per Deduction Period";
            dt.Columns[97].ColumnName = "Plan Deduction Cycle";
            dt.Columns[98].ColumnName = "Last Modified Date";
            dt.Columns[99].ColumnName = "Last Modified By";
            dt.Columns[100].ColumnName = "E-Sign Date";
            dt.Columns[101].ColumnName = "Benefit Allowance - Available";
            dt.Columns[102].ColumnName = "Benefit Allowance - Used";
            dt.Columns[103].ColumnName = "Benefit Allowance - Remaining";
            dt.Columns[104].ColumnName = "Benefit Allowance - Cash Back";
